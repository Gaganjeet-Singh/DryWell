        ...
        <div className='container mt-5 mb-5'>
            <div className='row'>
                ...
                <div className='col-6 mt-3 mb-3'>
                    <h5 className="mt-3 ">Our Story</h5>
                    <p className='p-3' style ={{lineHeight:"1.8"}}>FreshFold Laundry was born from a simple idea: laundry shouldn't be a chore that takes away from the things you love. Founded in 2018 by Sarah Mitchell, we started with a single van and a commitment to exceptional service.
